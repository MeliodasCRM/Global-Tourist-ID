...
const getState = ({ getStore, getActions, setStore }) => {
	return {
		store: {
			...
			groups: [], // Incializo el array de grupos
			...
			loadContacts: async () => {
				...
				try {
				  ...
				  if (response.ok) {
					...
					setStore({ contact: contacts });  // Actualizamos el store con todos los contactos
					console.log("Contactos cargados correctamente:", contacts);
				  } else {
