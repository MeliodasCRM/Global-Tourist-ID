...
Revision ID: a03c7ad7d71f
Revises: 
Create Date: 2025-01-20 18:58:02.811462
...
def upgrade():
    ...
    sa.Column('traveler03_id', sa.Integer(), nullable=True),
    sa.Column('traveler03_relac', sa.String(length=100), nullable=True),
    sa.ForeignKeyConstraint(['traveler01_id'], ['contact.id'], ),
    sa.ForeignKeyConstraint(['traveler02_id'], ['contact.id'], ),
    sa.ForeignKeyConstraint(['traveler03_id'], ['contact.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
